<template>
  <div class="role">
    <div class="col-10 m-2"> <h2>Role and Right <span style="font-size: 15px;">Also available in : <span><a
      href="">SVC</a></span> <span><a href="">Excel</a></span> <span><a href="">Print</a></span></span></h2></div>
    ...
    <div class="mb-2 col-12">
      <div class="col-3 float-left">
        ...
        <button class="ml-2 btn btn-danger btn"><i class="fas fa-sync"></i> Refresh</button>
      </div>
    </div>
    <div class="m-4">
